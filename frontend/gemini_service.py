...
def analyze_resume(resume_text: str, jd_text: str, api_key: str, model: str = "gemini-2.5-flash") -> dict:
    if not api_key or not api_key.strip():
        raise ValueError("A valid Gemini API key is required to run the analysis.")
